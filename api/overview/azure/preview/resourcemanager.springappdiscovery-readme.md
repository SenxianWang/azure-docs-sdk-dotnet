---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.SpringAppDiscovery, springappdiscovery
ms.date: 10/22/2024
ms.topic: reference
ms.devlang: dotnet
...
Install the Microsoft Azure SpringAppDiscovery management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.SpringAppDiscovery --prerelease
```

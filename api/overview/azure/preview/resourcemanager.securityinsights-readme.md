---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.SecurityInsights, securityinsights
ms.date: 10/25/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: securityinsights
---
# Microsoft Azure Security Insights management client library for .NET

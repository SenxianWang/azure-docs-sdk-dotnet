---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.CognitiveServices, cognitiveservices
ms.date: 10/21/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: cognitiveservices
---
# Microsoft Azure Cognitive Services management client library for .NET

---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.SqlVirtualMachine, sqlvirtualmachine
ms.date: 10/26/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: sqlvirtualmachine
---
# Microsoft Azure SQL Virtual Machine management client library for .NET

---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.StorageActions, storageactions
ms.date: 10/25/2024
ms.topic: reference
ms.devlang: dotnet
...
Install the Microsoft Azure Storage Actions management library for .NET with [NuGet](https://www.nuget.org/):

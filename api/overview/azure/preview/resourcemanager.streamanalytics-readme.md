---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.StreamAnalytics, stream-analytics
ms.date: 10/23/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: stream-analytics
---
# Microsoft Azure Stream Analytics management client library for .NET

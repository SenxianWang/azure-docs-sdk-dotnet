---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.EdgeZones, edgezones
ms.date: 10/25/2024
ms.topic: reference
ms.devlang: dotnet
...
Install the Microsoft Azure EdgeZones management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.EdgeZones --prerelease
```

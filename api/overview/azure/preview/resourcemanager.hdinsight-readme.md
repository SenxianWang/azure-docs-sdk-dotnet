---
title: Azure HDInsight management client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.HDInsight, hdinsight
ms.date: 10/21/2024
ms.topic: reference
ms.devlang: dotnet
ms.service: hdinsight
---
# Azure HDInsight management client library for .NET - version 1.2.0-alpha.20241021.1 
